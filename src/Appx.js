...
// : 
// "12"
const GOOGLE_MAPS_API_KEY = 'AIzaSyDaGDRlIrGc98vkOvpAz7xBagB-w06v80s';

const handleLocationSubmit = () => {
  
}
fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&key=${GOOGLE_MAPS_API_KEY}`)
